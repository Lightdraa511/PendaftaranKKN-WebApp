...
<div class="bg-white dark:bg-gray-800 shadow rounded-lg overflow-hidden">
    <div class="p-6">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-xl font-medium text-gray-900 dark:text-white">Edit Program Studi - {{ $fakultas->nama_fakultas }}</h2>
        ...
        <form action="{{ route('admin.fakultas.prodi.update', ['fakultas_id' => $fakultas->id, 'prodi_id' => $prodi->id]) }}" method="POST" class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg mb-6">
            @csrf
            @method('PUT')
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nama_program" id="nama_program" value="{{ old('nama_program', $prodi->nama_program) }}" class="w-full p-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-800 dark:text-white" required>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="kode_program" id="kode_program" value="{{ old('kode_program', $prodi->kode_program) }}" class="w-full p-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-800 dark:text-white" required>
